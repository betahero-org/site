...
<p align="center">  
    ...
    <a href="https://betahero.org" target="_blank">
...
This repository contains the source code for the new [BetaHero website](https://betahero.org). The site is written using [SvelteKit](https://svelte.dev), [TypeScript](https://typescriptlang.org/) and [SCSS](https://sass-lang.com), and deployed with [Netlify](https://www.netlify.com/).
